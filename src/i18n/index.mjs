...
export const dict = {
  zh: {
    ...
    entry: {
      ...
      types: { essay: '短文', note: '方法', 'case-study': '案例', research: '深度研究', consulting: '咨询', gallery: '影像' },
    },
  ...
  en: {
    ...
    entry: { updatedAt: 'Updated', publishedAt: 'Published', readingMinutes: (n) => `${n} min read`, readFull: 'Read full post', columnIn: (label, order) => `Part of the column “${label}” · Chapter ${order}`, tagsAria: 'Tags', columnChaptersAria: 'Column chapters', types: { essay: 'Short', note: 'Method', 'case-study': 'Case', research: 'Deep research', consulting: 'Consulting', gallery: 'Photos' } },
