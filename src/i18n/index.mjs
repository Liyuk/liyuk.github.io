...
export const dict = {
  zh: {
    ...
    share: { native: '分享', x: 'X', linkedin: 'LinkedIn', facebook: 'Facebook', pocket: '存到 Pocket', copy: '复制链接' },
  ...
  en: {
    ...
    share: { native: 'Share', x: 'X', linkedin: 'LinkedIn', facebook: 'Facebook', pocket: 'Save to Pocket', copy: 'Copy link' },
