...
export const dict = {
  zh: {
    ...
    page: {
      home: { metaTitle: '沉默土豆的烹饪指南 — Liyuk', eyebrow: '独立工作，持续进行', title: ['沉默土豆的', '烹饪指南。'], byline: 'Liyuk · 关于技术、领导力与日常的现场笔记', description: '这里记录技术、产品、领导力与日常观察；也是项目、研究和摄影慢慢汇合的地方。', aboutLink: '关于我', contact: '联系我', writing: { eyebrow: '01 / 写作', title: ['从工作中来，', '回到清晰的表达。'], link: '查看全部写作', empty: '写作档案正在整理。', featured: '精选', latest: '最近更新', archiveHint: (n) => `共 ${n} 篇 · 按年归档` }, practices: { projects: { label: '02 / 项目', title: '从问题到可以打开的东西。', description: '产品、工具和正在进行的实验。', count: (n) => `${n} 项` }, research: { label: '03 / 研究', title: '为尚未解决的问题保留空间。', description: '论文、研究笔记与演讲。', count: (n) => `${n} 篇` }, consulting: { label: '04 / 合作', title: '把复杂的职业问题，谈清楚。', description: '一对一咨询与专项顾问，从简历到管理成长。', cta: '查看咨询服务' }, photos: { label: '05 / 影像', title: '在屏幕之外，继续观察。', description: '照片与现场笔记。', count: (n) => `${n} 个图集` } }, start: { eyebrow: '阅读入口', title: '不知道从哪里开始？', description: '按你正在处理的问题，进入一条更短、更有顺序的阅读路径。', link: '从这里开始' }, practiceGridAria: '内容领域' },
