...
export const dict = {
  zh: {
    ...
    brand: site.brand,
    brandShort: '沉默土豆',
    navigation: { writing: '写作', columns: '专栏', projects: '项目', research: '研究', photos: '影像', about: '关于', start: '开始', tags: '标签', search: '搜索', main: '主导航', menu: '菜单', menuOpen: '打开菜单', menuClose: '关闭菜单' },
    ...
    subscribe: { prompt: '喜欢这个站？', cta: '订阅 RSS' },
  ...
  en: {
    ...
    navigation: { writing: 'Writing', columns: 'Columns', projects: 'Projects', research: 'Research', photos: 'Photos', about: 'About', start: 'Start', tags: 'Tags', search: 'Search', main: 'Main navigation', menu: 'Menu', menuOpen: 'Open menu', menuClose: 'Close menu' },
    ...
    subscribe: { prompt: 'Enjoy this site?', cta: 'Subscribe via RSS' },
