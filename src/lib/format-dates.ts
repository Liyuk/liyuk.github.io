...
// content date (see content-date.ts) with fixed rules for each locale.

const MONTHS: Record<'en' | 'zh-CN', string[]> = {
...
export function formatFullDate(date: Date, locale = 'zh-CN'): string {
...
export function formatYearMonth(date: Date, locale = 'zh-CN'): string {
