...
I later looked at the same question across more domains, including content, search, transactions, and growth. “Where should a difference live?” was only the first question; the next was how that difference should be configured, orchestrated, and governed. I describe that configuration-driven architecture in “Keep Differences in Configuration: Architecture for a Multi-Domain Platform.”
