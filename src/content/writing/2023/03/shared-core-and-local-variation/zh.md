...
一个系统开始服务第二个地区、第二类客户或第二条业务线时，团队常陷入两难：继续复制一份，担心维护成本失控；立刻做成"统一平台"，又发现真实差异远比预想多。

这不是抽象能力不够，而是系统尚未分清什么已经稳定、什么仍在变化。
...
第一，基础不牢：底层能力不稳定，却先叠加复杂抽象。第二，领域不清：不知道业务规则为何存在，就把偶然相似当成必然共性。第三，业务不清：目标和未来变化没有被说明，架构只能猜测未来。
...
如果答不清，先保留局部实现，比过早搭平台更安全。延迟抽象不是放弃设计，而是在为正确设计保留证据。
...
多地区系统的目标不是"代码只有一份"，而是让共享带来真实收益，让变化不必伤害其他使用者。边界清楚、责任清楚，系统才有机会随着地区和业务一起演进。好架构不是让系统看起来统一，而是让团队在变化时能以合适成本调整；能随着事实移动边界，才是架构判断力。
