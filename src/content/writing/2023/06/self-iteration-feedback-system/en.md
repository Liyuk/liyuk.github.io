...
translationKey: 2023/06/self-iteration-feedback-system
---
...
```mermaid
flowchart LR
    A["Define problem"] --> B["Collect observations"] --> C["Form hypothesis"] --> D["Small experiment"] --> E["Retrospect & integrate"]
    E --> A
```
