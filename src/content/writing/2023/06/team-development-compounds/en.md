...
1. **Clear outcome**: know what counts as done, and know which goal it serves;
2. **Controllable boundaries**: decision rights, time, and collaboration scope match the responsibility;
3. **Support available**: at key points someone can provide context, challenge, and feedback, rather than taking over only at the end.
