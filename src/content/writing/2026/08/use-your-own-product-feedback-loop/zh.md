...
“开发者应该多用自己的产品”听上去几乎没有人会反对。但它很容易落成一项没有结果的要求：大家在某个晚上打开产品、刷十分钟内容、提几个零散问题，然后下次继续从头开始。
...
## 结语：开发者最有价值的优势，是能回到用户的位置

开发者熟悉系统的内部逻辑，这是解决问题的优势；但它也容易让人跳过用户必须经历的困惑。真实自用的意义，是暂时放下这些“知道”，重新体验用户如何找到入口、理解反馈、承担等待和面对失败。

当“多用产品”被设计成一条完整的反馈回路时，它不再是一种额外负担，而是开发工作的一部分：每一次真实任务，都可能让我们更早看见一个本来要等到用户投诉后才会发现的问题。
