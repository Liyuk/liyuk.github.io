...
观察企业的运作结构，可以先看三种权力：**人、事、钱。**

这里的“人”是人事权：谁能招人、任用、评价、晋升、调动和终止雇佣关系；谁能设计岗位、改变汇报关系，决定一个人的负责范围。

这里的“事”是问题与优先级决定权：谁能定义问题，确定优先级，改变目标，决定做什么、不做什么，以及什么时候停止一项工作。

这里的“钱”是预算与人员容量配置权：谁能决定预算、编制、采购、供应商、设备、外包和团队容量；谁能让一笔投入持续下去，或者把资源从一个方向移到另一个方向。
...
一个人被任命为部门负责人，不代表他自动拥有这个部门所有的人事、事项和预算权。他可能拥有团队日常管理权，却没有关键岗位的最终任命权；拥有业务目标，却不能独立调整目标；拥有预算额度，却不能把预算转成编制；拥有跨部门项目的责任，却不能调度其他团队的资源。
...
一个团队说“我们需要更多人”，更高层可以追问：真正的问题是人手不足，还是目标过多？一个团队说“项目延期”，管理层可以重新定义：问题是执行效率，还是优先级从未真正被调整？一个部门说“需要新系统”，组织可以继续追问：这是系统问题，还是流程、责任和客户承诺的问题？
...
一个项目拿到预算，却没有明确负责人，钱不会自动变成结果；一个团队拿到新的编制，却保留了所有旧承诺，新人只会增加系统的复杂程度；一个方向被宣布为最高优先级，却没有任何团队释放资源，它仍然只是一次表达。
...
本文是一套观察和讨论组织权力边界的管理框架，例子均为抽象场景，不对应某家公司、个人或内部制度。实际的人事、预算、绩效、调岗和退出决定，仍需遵守所在组织的授权流程、政策与适用法律；本文不是针对具体个案的人力资源、法律或合规建议。
