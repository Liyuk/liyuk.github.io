---
title: "Managing Teams as a Manager of Managers: Authority and Resources"
description: How a manager of managers can coordinate frontline managers, make cross-team choices, and use authorization and resources without taking back daily management.
...
translationKey: 2026/08/manager-of-managers-management-and-authority
---
...
```mermaid
flowchart TB
  A[Shared goal] --> B[Facts, constraints, and cost]
  B --> C{Can one team decide?}
  C -->|Yes| D[Frontline leader decides and records]
  C -->|No| E[Second tier presents options and trade-offs]
  E --> F{Safety, compliance, privacy, or fairness boundary?}
  F -->|Yes| G[Specialist review or escalation]
  F -->|No| H[Overall outcome owner decides]
  D --> I[Record owner, review condition, and end date]
  G --> I
  H --> I
  I --> J[Temporary authority ends; daily ownership returns]
```
...
flowchart TB
  ...
  C -->|No| E[Overall outcome owner chooses]
  E --> F{Specialist safety or compliance boundary?}
  F -->|Yes| G[Authorized specialist review or escalation]
  F -->|No| H[Implement choice]
  G --> H
  H --> I[Record trade-off, owner, review trigger, and recovery cost]
```
