...
type: note
tags: [beauty, everyday-life, guide, skincare, field-notes]
translationKey: 2025/04/from-skin-observation-to-product-selection
---
...
![Facial observation illustration: centered on the portrait, marking face shape, three-part/five-eye proportions, skin undertone, and lightness observation](./images/facial-observation-chart.webp)
...
![Everyday makeup direction recommendation: the same portrait paired with eyeshadow, blush, and lip-color swatches](./images/makeup-direction-board.webp)
...
![Personal color exploration: four groups of clothing, lip, blush, and hair-color inspiration swatches for Spring, Summer, Autumn, and Winter](./images/personal-color-exploration.webp)
...
![Skin condition observation illustration: using zones and status bars to record hydration feel, oiliness, texture, evenness, the eye area, and comfort](./images/skin-observation-sheet.webp)
...
![Everyday soft makeup before/after reference: natural base, soft eye makeup, light blush, and everyday lip color](./images/everyday-makeup-simulation.webp)
...
```mermaid
flowchart LR
    A["Face shape · three-part/five-eye proportions"] --> B["Color · skin tone"] --> C["Makeup direction"]
```
