...
translationKey: 2020/10/what-good-technical-sharing-should-change
---
...
```mermaid
flowchart LR
    A["Problem in practice"] --> B["Topic & research"] --> C["Discussion & challenge"] --> D["Conclusion, boundaries & next step"] --> E["Follow-up practice & feedback"] --> A
```
