...
只要其中一个问题的答案是肯定的，就值得留下某种形式的复盘。目的不是制造流程，而是避免经验只停留在参与者的记忆里。
...
这里的差别不是谁的工作更重要，而是避免两种浪费：为很小的问题组织一场没有新增信息的会议，或用几句笼统结论处理本该被认真理解的问题。
...
会议结束前，应逐项确认行动的交付物、负责人、检查时间和完成标准。不同性质的改进可以分层：立刻可以调整的默认做法，近期需要补齐的检查或说明，以及需要进一步验证的长期改动。分层不是为了把难题推远，而是让每一项都有合理的下一步。
...
这样，复盘才不是一次性档案，而是能持续更新的工程知识。未来遇到相似情况的人，需要找到的不只是“当时做了什么”，更是“什么判断已被验证，什么仍然需要谨慎”。
...
因此，复盘应当安排一次轻量回看。回看的问题很简单：承诺的改变是否发生？它是否真的改善了目标问题？有没有带来新的成本或盲区？如果答案是否定的，也应当留下记录。撤回无效措施不是失败，而是让组织避免把一项未经验证的做法固化成仪式。

最好的复盘不会让团队记住某次经历有多曲折，而会让下一次工作少依赖运气和记忆。它留下的不是一份对过去的判词，而是一组能够被未来继续检验和改进的工程判断。
