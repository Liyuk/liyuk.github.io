---
title: 职场关系分析协议：权力、权责与结构位置
description: 一篇研究设计与协议论文：提出一套以可核验信号为目标、面向职场场景的材料组织与工作关系分析协议，覆盖上中下三层级的工作安全、权力结构、横向竞争、权责错位、职业安全、职业发展与职业心理健康。
...
职场冲突很容易被表达成一个"看穿对方"的问题：这个领导是不是不行、这个同事是不是在构陷我、这个合作方是不是故意使坏。本文主张这个目标既不可靠也无必要。人类与 AI 都无法从沟通记录中可靠地推断他人动机或人格；真正可以核验的是互动结构——谁掌握信息、谁有权决定、责任流向哪里、风险由谁承担。本文并不预设某一方是加害者：同一段材料里，不同位置的人同样可能分别承担或制造风险，协议把这些位置都当作可核验的结构对象，而非诊断或审判的对象。它把分析对象从"一个人"转为"一段互动、结构位置与风险承担"，并提出一个职场关系分析协议：以识别可核验信号与保护性行动为目标的材料组织与关系分析框架。
...
这里需要先明确：权力不对等本身不是指控，也不意味着上级一定越界。一个运转良好的组织里，上下级同样可以处在权力不对称中而保有健康的工作关系；协议的目的不在揭发某个人，而在标注"管理行为是否留有可核验、可申诉的出口"。在这个前提下看待职场里最常见的风险形态——**上下级之间的权力不对等**。上级掌握绩效、晋升、关系网络与资源分配，这种杠杆让越界行为可以被包装成"管理风格""工作要求"或"为你好"。菲佛指出，这种位置差异本身就是权力的来源[1]。
...
**第三，管理权限的使用需要可核验的边界。** 扮演管理角色、行使绩效、排班、资源分配与汇报路径等权限，本身是组织的正当职能；协议关注的不是权限本身，而是它是否留有可申诉、可拒绝的出口。当权限被用来**反复**施加无法申诉的惩罚、把某一方固定在弱势位置上，而行为又与"管理职责"表面重合因而难以识别时，就进入了权责不对等与欺凌谱系。这一点与职场欺凌研究[3]"反复发生、方向固定的负面对待"一致：单次绩效批评不是霸凌，反复的、方向固定的、无申诉出口的惩罚才是。
...
职场关系分析的困难，不在于看懂某个人，而在于看清结构：谁掌握信息、谁有权决定、责任流向哪里、风险由谁承担。本文的协议把这些结构因素拆成证据、假设、反例、核验和行动——对纵向权力，它区分"管理"与"伪装成管理的越界"；对横向竞争，它区分"竞争"与"构陷"；对权责，它区分"合理的系统决策"与"让某一方承担与决定权不匹配的责任"。
